...
def intersect_gt_dr(GT_PATH, DR_PATH):
    #GT_PATH="../"+GT_PATH
    #DR_PATH='../'+DR_PATH
    print(os.getcwd())
    ...
    os.chdir("/rwthfs/rz/cluster/home/aq493324/transformer/Seq2seq"+GT_PATH[2:])
    gt_files = glob.glob('*.txt')
    if len(gt_files) == 0:
        print("Error: no .txt files found in", GT_PATH)
        sys.exit()
    os.chdir("/rwthfs/rz/cluster/home/aq493324/transformer/Seq2seq"+DR_PATH[2:])
    ...
    backup("/rwthfs/rz/cluster/home/aq493324/transformer/Seq2seq"+GT_PATH[2:], gt_backup, backup_folder)
    backup("/rwthfs/rz/cluster/home/aq493324/transformer/Seq2seq"+DR_PATH[2:], dr_backup, backup_folder)
    if gt_backup:
    ...
    os.chdir("/rwthfs/rz/cluster/home/aq493324/transformer/Seq2seq/main")
